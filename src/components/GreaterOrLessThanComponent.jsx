...
import { ComparingNumbersFetch } from "../services/DataServices";
...
const GreaterOrLessThan = () => {
    ...
    const fetchResponse = async () => {
        ...
        {
            setDisplay(await ComparingNumbersFetch(userInput, userInput2));
        }
    }
    ...
    return (
        ...
        <div className='flex justify-center'>
            <h1 className='p-2 text-3xl'>Greater or Less Than</h1>
        </div>
        ...
        <div className="grid min-h-screen grid-cols-1 grid-rows-4 ml-8 mr-8 overflow-hidden bg-black md:mb-16 md:ml-16 md:mr-16 rounded-3xl">
                ...
                <div className="flex justify-center place-items-center">
                    <h1 className="flex h-32 p-2 m-2 text-xl text-center bg-pink-500 md:text-2xl place-items-center w-fit rounded-3xl">{display}</h1>     
                </div>
                
                <div className="flex justify-center place-items-center">
                    <NavLink to={'/'}>
                    <button className="h-32 text-4xl bg-pink-500 w-36 rounded-3xl">Home</button>
                    </NavLink>
                </div>
                ...
                <div className="flex justify-center place-items-center">
                    <button onClick={fetchResponse} className="h-32 text-4xl bg-pink-500 w-36 rounded-3xl">Enter</button>
                </div>
...
export default GreaterOrLessThan;